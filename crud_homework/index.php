            ...
            <div class="card">
                ...
                <div class="d-flex">
                    ...
                    <div class="action d-flex justify-content-end">
                        <a href="update_html.php?id=<?php echo $id ?>" class="btn btn-primary btn-sm mr-2"><i class="fa fa-pencil"></i></a>
                        <a href="delete_model.php?id=<?php echo $id ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                    </div>
                </div>
            </div>
        <?php
